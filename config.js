...
const HOME_DATA = {
  ...
  notices: [
    { title: "트윈 피트니스 26년 3분기 정기 회원 모집 안내", date: "06.05", content: "3분기 정기 회원 모집을 시작합니다. 신청은 1층 피트니스 데스크에서 가능하며, 자세한 사항은 관리사무소로 문의해 주세요." },
    { title: "6월 4일(목) 트윈 통근 퇴근버스 운행 안내", date: "06.04", content: "6월 4일(목) 퇴근버스는 평소와 동일하게 18:30 정문 출발 예정입니다. 교통 상황에 따라 다소 지연될 수 있습니다." },
    { title: "중원 지하1층 고메스트릿 신규 매장 오픈", date: "06.02", content: "중원 지하1층 고메스트릿에 신규 매장이 오픈했습니다. 많은 이용 부탁드립니다." },
  ],
